...
1. Copy `.env.example` to `.env` and add your Mapbox and Cloudinary credentials.
2. Run `docker compose up --build -d`.
3. Open `http://localhost:8080`.

See [`DOCKERIZATION.md`](DOCKERIZATION.md) for architecture, seeding, troubleshooting, production notes, and submission details.
